      ...
      <div className="bg-slate-500 text-slate-50 rounded-2xl p-3 drop-shadow-md shadow-lg w-full">
        <div className="inline-flex w-full ">
          <div className=" w-11/12">
            <h1><ContenderAndIcon name={props.bet.contenderName} image={props.bet.contenderImage} /></h1>
            <h1>{props.bet.title + " - " + props.bet.type.charAt(0).toUpperCase() + props.bet.type.slice(1)}</h1>
          </div>
          ...
          <div className="w-1/2 mr-1 border rounded-lg  p-1 text-sm">
            ...
            <div className="inline-flex text-gray-700 font-bold ">
              ...
              <input class="appearance-none block bg-transparent w-full text-gray-700 
                ...
                type="text"
                onChange={evt => onWagerChange(evt, setWin, setWager, props.bet.line)}
                value={wager}
              />
            </div>
          </div>
          ...
          <div className="w-1/2 ml-1 border rounded-lg p-1 text-sm">
            ...
            <div className="inline-flex text-gray-700 font-bold ">
              ...
              <input class="appearance-none block bg-transparent w-full text-gray-700 
                  leading-tight focus:outline-none"
                type="text"
                onChange={evt => onWinChange(evt, setWin, setWager, props.bet.line)}
                value={win}
              />
            </div>
          </div>
