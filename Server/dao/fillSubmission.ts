...
class FillDao {
    async createFill(
        aggressiveBetId: bigint, passiveBetId: bigint, aggressiveBookSide: SideDbEnum, aggressiveWagerAmount: bigint, passiveWagerAmount: bigint, passiveLine: bigint, aggressiveFullyFilled: boolean, passiveFullyFilled: boolean) {
